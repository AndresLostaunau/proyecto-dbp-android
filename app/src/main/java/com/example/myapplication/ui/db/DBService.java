...
//        }
//        log.info(dbService.getClientByUsername("admin").toString());
//        return dbService;
//    }
//
...
//        try{
//            Statement statement = connection.createStatement();
//            ResultSet resultSet = statement.executeQuery("SELECT id, password, balance FROM kito.a_client WHERE username="+username);
